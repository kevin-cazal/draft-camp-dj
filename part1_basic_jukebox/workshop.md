...
**Real-world analogy**: Imagine a digital billboard. Someone (the code) decides:
- What message to show ("OPEN 24 HOURS")
- Where to place it (center of the screen)
- How big to make it (large enough to read)
- What color to use (bright and eye-catching)
...
**Real-world example**: Imagine you're making a recipe that says "butter" 10 times. If you want to use margarine instead, you'd have to change it 10 times. But if you had a variable like `fat = butter`, you'd only change it once!
...
2. Stock the shelves (load images and sounds - we'll do this later)
...
**Real-world analogy**: Imagine you're decorating a room. The background image is like the wallpaper - you can change it to create a different mood or theme.
...
**Real-world analogy**: On a vending machine, each button triggers a different action (dispensing a different snack). Our jukebox buttons will trigger different sounds or change backgrounds.
