...
**Real-world analogy**: 
- **Before**: Like building a new house from scratch for each new item
- **After**: Like adding an item to a shelf - the shelf system already exists!
...
**Real-world analogy**: Like a TV remote with a "hide controls" button:
- Press it → controls disappear (clean view)
- Click anywhere → controls reappear (interaction ready)
